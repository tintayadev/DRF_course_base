...
curl -X POST -F 'username=root' -F 'password=1234' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=root password=1234


> This will retrieve all items

curl -X GET -H 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b'


> This will retreive a single item

curl -X GET -H 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' http://api:8000/item/0951a0a8-152e-4cd1-8e89-d22cfc96b95d/

http http://api:8000/item/0951a0a8-152e-4cd1-8e89-d22cfc96b95d/ 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b'

> This will place an order for item id = dde3a574-9ee5-480e-ba61-82a98ed1cbb8 quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' -d '{"item": "dde3a574-9ee5-480e-ba61-82a98ed1cbb8", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' item="dde3a574-9ee5-480e-ba61-82a98ed1cbb8" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/**your_order_uuid**/ 'Authorization: Token 97c32090c4387afe26c2e98b650f63cb815bb20b'
