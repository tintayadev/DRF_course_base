...
class EcommerceTestCase(APITestCase):
    ...
    def test_create_order_with_less_than_stock(self):
        '''
        test OrderVieSet create method when order.quantity < item.stock
        '''
        for i in self.items:
    ...
    def test_create_order_with_equal_stock(self):
        '''
        test OrderViewSt create method when order.quantity == item.stock
        '''
        for i in self.items:
            stock = i.stock
